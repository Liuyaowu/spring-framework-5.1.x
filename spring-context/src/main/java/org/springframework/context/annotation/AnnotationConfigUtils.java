...
public abstract class AnnotationConfigUtils {
	...
	/**
	 * 将所有相关的后置处理器注解注册到给定的registry(AnnotationConfigApplicationContext)
	 *
	...
	/**
	 * 检查通用的注解,将类中的注解信息(是否有该注解)设置到AnnotatedBeanDefinition这个描述类注解信息的数据结构中
	 * @param abd
	 * @param metadata AnnotatedBeanDefinition中拿到的元数据信息
	 */
